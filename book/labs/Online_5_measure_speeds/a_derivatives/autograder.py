...
class FunctionTestCase:
    ...
    def __init__(self, name, args=None, kwargs=None, retval=None, checker=operator.eq):
        self.name = name
...
class FunctionTestOutcome:
    ...
    def __init__(self, test_case, function):
        ...
        try:
            ...
            self.returned = None
            self.error = e
        self.success = (self.error is None) and test_case.checker(self.returned, test_case.retval)
